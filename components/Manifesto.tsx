  ...
  return (
    <section className="bg-white py-24 md:py-40 border-b border-gray-200">
      <div className="max-w-[1920px] mx-auto px-6 md:px-12">
        ...
        <div className="mb-20">
           <span className="text-[#D9281C] text-xs font-bold tracking-widest uppercase">(PRODUCTS)</span>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7">
            <h2 className="text-[#D9281C] text-6xl md:text-8xl font-medium tracking-tight leading-none">
              Wireless Speakers
            </h2>
          </div>
          
          <div className="lg:col-span-5 flex flex-col gap-12 pt-4">
            <p className="text-[#D9281C] text-2xl md:text-3xl leading-tight font-normal">
